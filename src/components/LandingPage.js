    ...
    render() {
        ...
        return (
            <Container className="LandingPage">
              ...
              <br />
              <Typography color='primary' variant='subtitle2' style={{marginTop: '30px'}}>Developed by <a target='_blank' rel="noreferrer" href='https://twitter.com/prayagSeriously' style={{textDecoration: 'none', color: 'inherit'}}>@prayagSeriously</a></Typography>
            </Container>
          )
    }
}
